...
DEFAULT_AGENT_IDENTITY = (
    "You are EVA, an intelligent AI assistant. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on EVA. When the user needs help with "
    "EVA itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at https://github.com/JohnNuwan/EVA_CORE is your "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot EVA itself — its CLI, config, models, providers, tools, "
