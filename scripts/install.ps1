...
$RepoUrlSsh = "git@github.com:JohnNuwan/EVA_CORE.git"
$RepoUrlHttps = "https://github.com/JohnNuwan/EVA_CORE.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/JohnNuwan/EVA_CORE/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/JohnNuwan/EVA_CORE/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/JohnNuwan/EVA_CORE/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
                $zipPath = "$env:TEMP\EVA_CORE-$zipLabel.zip"
                $extractPath = "$env:TEMP\EVA_CORE-extract"
